    ...
    <div class="p-mypage__container">
      <div class="p-login__forms">
        <div class="p-login__form">
          <label>メールアドレス</label>
          <input type="email" name="email" value="<?= isset($app->getValues()->email) ? h($app->getValues()->email): ($userNames->email); ?>" id="p-login__form-control">
          <p class="err"><?= h($app->getErrors('email')); ?></p>
        </div>
        <div class="p-login__form">
          <label>ユーザー名</label>
          <input type="text" name="username" value="<?= isset($app->getValues()->username) ? h($app->getValues()->username): ($userNames->username); ?>" id="p-login__form-control">
